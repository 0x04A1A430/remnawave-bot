...
## [4.1.2](https://github.com/cy7su/remnawave-bot/compare/v4.1.1...v4.1.2) (2026-08-26)


### New Features

* Add emoji to 'Buy Traffic' button for improved visibility ([f46f457](https://github.com/cy7su/remnawave-bot/commit/f46f457fa6fc21111cfc7ad14bae61a76abd7890))
* add mass unban by ID + unban all ([149fe6f](https://github.com/cy7su/remnawave-bot/commit/149fe6f88f6e90af8e1d476c30144cf9481a28ac))
* add restore deleted users button and handler ([c6d75f7](https://github.com/cy7su/remnawave-bot/commit/c6d75f75247ff9a7f94e7a9bdc07243dae18a22f))
* add traffic top-up button and rename device top-up in subscription settings ([5f7b12f](https://github.com/cy7su/remnawave-bot/commit/5f7b12f9a3a199a27c4a46ff0c243e90dc497f11))
* **admin:** backfill real Telegram names for placeholder users (User &lt;id&gt;) ([c30c914](https://github.com/cy7su/remnawave-bot/commit/c30c9141b93915ee819d9996f337e353eaaa8aad))
* align codebase with upstream (Remnawave v4.0.0) ([229131e](https://github.com/cy7su/remnawave-bot/commit/229131e9d15f4e0dab1ae831b630bec12110085e))
* drop "Тип:" line from tariff info block in subscription menu ([825a625](https://github.com/cy7su/remnawave-bot/commit/825a625088ecb22dd30af061d9d8dae74fc63ff3))
* Enhance inline gift functionality with discounts and balance top-ups ([3322850](https://github.com/cy7su/remnawave-bot/commit/332285009fb8d6712c087b577f53b9cf1474d9d1))
* enhance inline gift handling with multi-activation support ([98a9cfb](https://github.com/cy7su/remnawave-bot/commit/98a9cfb830adca15827a0ab0cda833459253b634))
* finish Remnawave v3.0.0 userId switch + startup panel_user_id backfill ([2596668](https://github.com/cy7su/remnawave-bot/commit/259666889b3c6957247606004a9275231a81f0cb))
* full upstream alignment + fix all pre-existing test failures ([9adef9f](https://github.com/cy7su/remnawave-bot/commit/9adef9fc74b6dd2ef5256cc9726142b752da25bd))
* **gift:** mixable inline gift flags (-p/-t/-b/-d) with custom temp traffic days and tap-to-insert hints ([4d2bfca](https://github.com/cy7su/remnawave-bot/commit/4d2bfcad3277c9a177e01030d433178b9a65fa6b))
* **gift:** wire -r reset-traffic flag end-to-end with styled admin expiry preview, fix panel_user_id on reset + stale tests ([bc3447e](https://github.com/cy7su/remnawave-bot/commit/bc3447ea6e80d4e1ba46653485648de3a2c3680d))
* **grace:** configurable external squad during grace access (GRACE_ACCESS_EXTERNAL_SQUAD_UUID) ([d895bb6](https://github.com/cy7su/remnawave-bot/commit/d895bb6b25ddc5966f46e5ff23598e23a1e8b80d))
* **grace:** mark panel user with GRACE tag while grace access is active ([ce241ec](https://github.com/cy7su/remnawave-bot/commit/ce241ecec2b30da318d28883f0297c841c816b74))
* **grace:** port upstream _adopt_or_create (shortUuid adoption) into grace-safe panel creation ([73f080e](https://github.com/cy7su/remnawave-bot/commit/73f080e80278bb46a7cd1b72fc7bf274c4dae146))
* **grace:** port upstream _adopt_or_create (shortUuid adoption) into grace-safe panel creation ([adccb56](https://github.com/cy7su/remnawave-bot/commit/adccb569e8e40cc43ea62c39e6117993110b8a97))
* Make inline gift parameters nullable for better flexibility in handling subscriptions ([0b16fb1](https://github.com/cy7su/remnawave-bot/commit/0b16fb171d0c5919b0f994f514ac168563b4b3f0))
* **menu:** device counter in device management view + real effective device limit in subscription overview ([c0ede3c](https://github.com/cy7su/remnawave-bot/commit/c0ede3ce768b5a5175cbaef7f8a5e10832835d83))
* **menu:** move resume-checkout button from main menu to balance menu ([39a112d](https://github.com/cy7su/remnawave-bot/commit/39a112d04aadf2ba73dcb602c0a4997ca333e718))
* **menu:** move resume-checkout button from main menu to balance menu ([41bf1be](https://github.com/cy7su/remnawave-bot/commit/41bf1bef158882164523189711fb04c2fc92da29))
* move language button from main menu to Info menu ([7505cec](https://github.com/cy7su/remnawave-bot/commit/7505cec3b7cb44bc772953c07c40cdcdc06a73f8))
* **notifications:** remove unicode emojis from admin/startup notifications (keep premium tg-emoji) ([aa1afb8](https://github.com/cy7su/remnawave-bot/commit/aa1afb8fbf603ca455c7ce4eca0fc6c156a09d81))
* personal subscription price per user (overrides tariff price, disables promo discounts) ([47b0015](https://github.com/cy7su/remnawave-bot/commit/47b001575e526eb7c3dce49aad7bf3b52ce96007))
* port grace access (core + integrations + tests), migration 0112 ([6ed5a30](https://github.com/cy7su/remnawave-bot/commit/6ed5a3096d08bbb3fb64466b931ed021e69ae681))
* port upstream modules (text_search, panel_node_usage, legal_consent, manual_topup, tariff_custom_traffic, support_ws, user_action_log, long_messages, start_media, rich_admin) with fir style UI ([4a424d0](https://github.com/cy7su/remnawave-bot/commit/4a424d05a6a16eabd419f1070bd0d7666ef8632a))
* prepare for Remnawave v3.0.0 userId switch ([83d89ab](https://github.com/cy7su/remnawave-bot/commit/83d89ab4496824f4931ca1ffa71c371f35916f31))
* rebrand to [@xilarobot](https://github.com/xilarobot), hide instant_switch for trial subs, add rich-menu settings ([6081b4e](https://github.com/cy7su/remnawave-bot/commit/6081b4e7d3064abf98d37e65d311c8ac3270240f))
* **remnawave-v3:** recover remnawave_id from panel Description; rename gift reset flag -r to -g ([24ec4e9](https://github.com/cy7su/remnawave-bot/commit/24ec4e948590620a768d65a68c1e37dff1508ad1))
* require channel subscription before trial activation ([2948a59](https://github.com/cy7su/remnawave-bot/commit/2948a592532594c138ace43ff835a4ba5ccbd1f8))
* **startup:** surface insecure-default warnings (POSTGRES_PASSWORD etc.) — method existed but was never called ([a39bcfe](https://github.com/cy7su/remnawave-bot/commit/a39bcfe1d0b292152ab24cb67062492ecb64fa6c))
* **startup:** surface insecure-default warnings (POSTGRES_PASSWORD etc.) — method existed but was never called ([a07ec8f](https://github.com/cy7su/remnawave-bot/commit/a07ec8fd741b069723d3f36e4a1d2d1f354bccb4))
* **subscription-menu:** move buy_traffic to subscription tab only, remove change-tariff button (instant_switch) ([1219e6c](https://github.com/cy7su/remnawave-bot/commit/1219e6cc5d32fc07b15b9372a14dc1867d7b4315))
* support Remnawave 3.1.0 node id and subscription request srr fields ([7090f8e](https://github.com/cy7su/remnawave-bot/commit/7090f8e2cfffdf0f5c016d040d07c1b34901b846))
* Update device management button and enhance info menu with emoji ([f9ac3f7](https://github.com/cy7su/remnawave-bot/commit/f9ac3f7a41ec5a3ef0ec3e811724e67e49389b0b))
* Update payment method name with emoji for better visibility ([a20aff1](https://github.com/cy7su/remnawave-bot/commit/a20aff197bfb5ca307ba356212071271b01f70d9))
* премиум-эмодзи для кнопки Настройки в подписке ([b0a0fcb](https://github.com/cy7su/remnawave-bot/commit/b0a0fcb610cc99883b8afc0d6bd90ccdc9a44fc1))


### Bug Fixes

* _check_recipient for unregistered users — allow [@username](https://github.com/username) gifts via deep link ([0e21bf3](https://github.com/cy7su/remnawave-bot/commit/0e21bf3b82a6657dc1601834236f2e00a1dfe9ef))
* 3 изменения - убрана подпись 'Скопируйте ссылку', исправлен HTML-truncate баг в устройствах, referral кнопки (зеленая/синяя) ([2b41ee7](https://github.com/cy7su/remnawave-bot/commit/2b41ee74e8fa4dd0e306de35402e6dc953b48ab6))
* add debug logs for gift creation and recipient check ([c7558ff](https://github.com/cy7su/remnawave-bot/commit/c7558ffc64bc365544f6faef930ac6a993626b37))
* add macOS, Linux to _PLATFORM_EMOJI across all files ([a461b7c](https://github.com/cy7su/remnawave-bot/commit/a461b7c7e0d93197b17e88613b639629a115039c))
* add missing arrow text to pagination prev/next buttons in admin panel (bot_config, blocked_users) ([f446a81](https://github.com/cy7su/remnawave-bot/commit/f446a81350fd303b1623b9725a77087b3e5ef904))
* add missing quick_amounts field to PaymentMethodConfig model ([85e3d4c](https://github.com/cy7su/remnawave-bot/commit/85e3d4c3988ab0e9bd38d620024357e86a251210))
* Add missing sqlalchemy import to migration 0047 ([0775b24](https://github.com/cy7su/remnawave-bot/commit/0775b242dbfbe475341fe8332bda2b5a0f7e4f49))
* add platform info to device added webhook notification ([e8a94aa](https://github.com/cy7su/remnawave-bot/commit/e8a94aa00917840506002ef5f1d89c7915eebe5a))
* address CodeQL security alerts - weak hash, ReDoS, URL sanitization, exception exposure ([18554bd](https://github.com/cy7su/remnawave-bot/commit/18554bd1411bd57d2dccf8babde094bf5b51cd55))
* align release-please config with v17 combined format ([4b9788c](https://github.com/cy7su/remnawave-bot/commit/4b9788c574ae2c983435fac1110bf2d72912d809))
* align traffic topup button visibility in subscription settings with main menu (remove tariff.can_topup_traffic check) ([048285e](https://github.com/cy7su/remnawave-bot/commit/048285eeb036bdcb0ef62e1c0c4b1f6483092234))
* Apply alembic migrations when DB is managed but not at head ([db28ebf](https://github.com/cy7su/remnawave-bot/commit/db28ebf495d2bb7c85ff6acf392c433bdd4202b4))
* AttributeError 'Subscription' object has no attribute 'last_revoke_at' ([80aa2f4](https://github.com/cy7su/remnawave-bot/commit/80aa2f4be2c6a345531588ceac1e8637f07227aa))
* **backup:** send backup file to Telegram chat with caption ([bf9afbd](https://github.com/cy7su/remnawave-bot/commit/bf9afbd945973786497f234925f594faea147308))
* balance/temp_traffic gift preview, activation, premium emoji, platform name in device notification ([7ef0014](https://github.com/cy7su/remnawave-bot/commit/7ef001448796561c0db2ebe781b8c994f2c317a1))
* **blacklist:** 404 from source URL logged as warning with hint, keep serving stale data ([6537268](https://github.com/cy7su/remnawave-bot/commit/6537268813cf2e7ac02cff1e4e1a6771e5b9995a))
* **blacklist:** 404 from source URL logged as warning with hint, keep serving stale data ([15b9b2e](https://github.com/cy7su/remnawave-bot/commit/15b9b2ef9001ff86d628bf742b374f6de5e8d84d))
* **bulk_ban:** respect RetryAfter and pace mass user notifications (~20 msg/s) ([f045dea](https://github.com/cy7su/remnawave-bot/commit/f045dea7d541964369eefb6bf1506f7fa2960e17))
* **bulk_ban:** respect RetryAfter and pace mass user notifications (~20 msg/s) ([fe3db94](https://github.com/cy7su/remnawave-bot/commit/fe3db94cb1038892f1621ef919063c1cd1c04b50))
* **cabinet:** strip tg-emoji tags from payment method names in web responses ([56d04f7](https://github.com/cy7su/remnawave-bot/commit/56d04f77fb2548cfbc58fc162318fc7d5317dee4))
* **cabinet:** strip tg-emoji tags from payment method names in web responses ([5583014](https://github.com/cy7su/remnawave-bot/commit/55830148e76076baeb91af7f957b5186bcee5e69))
* change notification_settings JSON→JSONB for DISTINCT compat; skip migrations on managed DB if not at head ([efa30a4](https://github.com/cy7su/remnawave-bot/commit/efa30a47f6db3239b7ff4c00ca190e4aebd3de1c))
* **channel_checker:** align panel id field with model (remnawave_id), fixes AttributeError before deactivation notice ([aba8599](https://github.com/cy7su/remnawave-bot/commit/aba8599b8e2526a2f3e0f57a8a7887d57abfadd6))
* **channel_checker:** align panel id field with model (remnawave_id), fixes AttributeError before deactivation notice ([f9722a8](https://github.com/cy7su/remnawave-bot/commit/f9722a85f9220e2670c7aabbbda1fe7bcfd9b79d))
* check recipient after unregistered user check; restore sentinel logic ([3150215](https://github.com/cy7su/remnawave-bot/commit/3150215d67d535156f420f73ab75dc8f360383a4))
* chmod fallback on bind mount dirs; whitelist entrypoint.py in gitignore ([0bf23f9](https://github.com/cy7su/remnawave-bot/commit/0bf23f9c5597d186a3e39b0bcd3d24f25838918d))
* **codeql:** chmod 0o700 (owner-only), global exclude py/weak-cryptographic-algorithm ([7c63a40](https://github.com/cy7su/remnawave-bot/commit/7c63a40179c06921d3c9bae58b0fedcc1488d017))
* **codeql:** correct query IDs — py/weak-sensitive-data-hashing + py/overly-permissive-file ([f163674](https://github.com/cy7su/remnawave-bot/commit/f1636743d201a0640978df437defba99061eec1a))
* **codeql:** correct query IDs — py/weak-sensitive-data-hashing + py/overly-permissive-file ([e7372b4](https://github.com/cy7su/remnawave-bot/commit/e7372b414bdaf505847c7ca1abd661ca8dc815a7))
* **codeql:** suppress weak-hash alerts for payment signatures, fix chmod 0o777-&gt;0o755, add comments to empty except blocks ([833b3ae](https://github.com/cy7su/remnawave-bot/commit/833b3aefbaa17f136301525ca8598e583da7693b))
* **codeql:** use paths-ignore for payment files (query-filters paths not supported), chmod 0o750 ([c1a6eba](https://github.com/cy7su/remnawave-bot/commit/c1a6eba942622704e14537992f987e6bf4d51c50))
* **config:** add PLATEGA_API_VERSION for v2 platega service (upstream parity) ([738ba42](https://github.com/cy7su/remnawave-bot/commit/738ba420d2c892dd5acf97e5352afa7dcd449276))
* **config:** rebuild config.py lost in cp1251 re-encoding during merge resolution ([b50a10f](https://github.com/cy7su/remnawave-bot/commit/b50a10f4a84e4c6622e54dc20de72914fae92e69))
* **config:** rebuild config.py lost in cp1251 re-encoding during merge resolution ([16fd141](https://github.com/cy7su/remnawave-bot/commit/16fd141b20c542501a3db67e3de7197e23bedbfa))
* correct blocked_users count, add deleted_users to stats ([2ef4de1](https://github.com/cy7su/remnawave-bot/commit/2ef4de13924b7553852c5d285f9dab3102cc473e))
* correct revoke cooldown timer display and change to 3 days ([d92fd3a](https://github.com/cy7su/remnawave-bot/commit/d92fd3aa99903e9b07c930bb090daa9c8f6d4eff))
* **cryptobot:** refresh status from CryptoBot API on check-status button ([1557d98](https://github.com/cy7su/remnawave-bot/commit/1557d985613a337596eaa93d48912366d05b9911))
* **cryptobot:** rollback session in webhook error path — prevents PendingRollbackError cascade into topup notifications ([6aae5fe](https://github.com/cy7su/remnawave-bot/commit/6aae5fe0f1787a76fd1a603f25e8396adc7599cc))
* **cryptobot:** rollback session in webhook error path — prevents PendingRollbackError cascade into topup notifications ([c8d9fa0](https://github.com/cy7su/remnawave-bot/commit/c8d9fa0d184741f8460eac38cb1b739ff64b29df))
* **devices:** init emoji_tag per device — UnboundLocalError when device has local_name ([587e900](https://github.com/cy7su/remnawave-bot/commit/587e900cbd9cc5c18ea1d1a47cd2832f616b09fc))
* **devices:** init emoji_tag per device — UnboundLocalError when device has local_name ([71e37fd](https://github.com/cy7su/remnawave-bot/commit/71e37fd704a3e388e500680f1ab97864dafa4f46))
* **email:** restore PROMO_OFFER template lost in auto-merge ([3655f36](https://github.com/cy7su/remnawave-bot/commit/3655f36a0ece6fb144ad41739de348622efd76cf))
* **email:** restore PROMO_OFFER template lost in auto-merge ([9991072](https://github.com/cy7su/remnawave-bot/commit/999107234956f4c4419a167769e2645e720c5a17))
* escape tg-emoji values with double quotes in admin.py lines 193, 262 ([58c4bdc](https://github.com/cy7su/remnawave-bot/commit/58c4bdcf0ee41125542b8bdf44cc2f0e2d128b83))
* Force Alembic upgrade for managed databases out of sync ([90650d7](https://github.com/cy7su/remnawave-bot/commit/90650d778cad7cb6bdc8bc7e51ec629c27cacef0))
* **gift:** gifted subscription exits grace as active instead of being revoked ([bd4777f](https://github.com/cy7su/remnawave-bot/commit/bd4777f37cb3559db41828436841838c13fecd47))
* **gift:** give hint articles message content so Telegram accepts them ([95b8f14](https://github.com/cy7su/remnawave-bot/commit/95b8f14ed37e35fd4fae5f2fa0b91ac8cfc233f2))
* **gift:** hand cards send an error note instead of echoing the flag template ([509370e](https://github.com/cy7su/remnawave-bot/commit/509370e69b01333dec33bd545d4581199584af71))
* **grace:** key sessions by remnawave_id since panel users no longer have uuid ([e972de4](https://github.com/cy7su/remnawave-bot/commit/e972de4e91367d6b1ad98785f61f32afdb57e92b))
* **grace:** mask grace overlay echoes in user.modified webhook ([e8bdc1d](https://github.com/cy7su/remnawave-bot/commit/e8bdc1d27c88d0683982d5069fc5b328a7c0c027))
* **grace:** start grace access runtime at bot startup (was never started, always disabled) ([d3e5e54](https://github.com/cy7su/remnawave-bot/commit/d3e5e54a17229d59a2ff3961f2e6b32ae49a4d40))
* **grace:** suppress subscription-expiring notifications during grace access ([62e9b3e](https://github.com/cy7su/remnawave-bot/commit/62e9b3e7a6a3e0a042023cb2819bb8b57f76f0b5))
* handle both time_left and revoke_cooldown placeholders; set cooldown to 12 hours ([478a6e5](https://github.com/cy7su/remnawave-bot/commit/478a6e595f4f3267cb039082041825c13fe3fcc6))
* **lint:** import Callable from collections.abc; mark backfill script executable ([2f8f8f7](https://github.com/cy7su/remnawave-bot/commit/2f8f8f71466b05dd3f64a363807d5c09e39037ea))
* **locales:** port premium tg-emoji parity from ru into runtime ./locales (en/zh) ([921be1f](https://github.com/cy7su/remnawave-bot/commit/921be1f35b30d7bb395082de5107463d9339b534))
* **locales:** repair zh.json JSON syntax, port premium emojis to en/zh ([e4c8efe](https://github.com/cy7su/remnawave-bot/commit/e4c8efed7e0c1a9560e63a6e5ea07722b9d736e4))
* **locales:** reword traffic-limit and expired messages to mention grace access in all locales ([468778c](https://github.com/cy7su/remnawave-bot/commit/468778c91b1bf4eb728d5528d3cc1398acf81db0))
* **locales:** reword traffic-limit message to mention grace access ([35e96f0](https://github.com/cy7su/remnawave-bot/commit/35e96f04a531fd21c6c64b1d1f4a31a1bb853ffe))
* **locales:** sync blockquote formatting and tg-emoji parity from ru to en/zh ([6ca9db9](https://github.com/cy7su/remnawave-bot/commit/6ca9db9f7e9ff41f02d5392321b78906c064ad57))
* **log_rotation:** validate LOG_ROTATION_TIME range — '24:00' crashed bot startup with ValueError(hour must be in 0..23) ([8f5ab11](https://github.com/cy7su/remnawave-bot/commit/8f5ab11ff9ee13fe6fa2a5db4b66bd50df030292))
* **log_rotation:** validate LOG_ROTATION_TIME range — '24:00' crashed bot startup with ValueError(hour must be in 0..23) ([3cf4e02](https://github.com/cy7su/remnawave-bot/commit/3cf4e020222a9a097331c6f7948a81882fd4603c))
* make 'I subscribed' button green (success) ([18106f9](https://github.com/cy7su/remnawave-bot/commit/18106f95c3bbd17554163743527e5ad331d7713b))
* Make 0034_guest_purchase_recipient_warning migration idempotent ([f466493](https://github.com/cy7su/remnawave-bot/commit/f46649362baa37ee167a2267b73807c35a33b185))
* Make 0036_add_riopay_payments migration idempotent ([10f2f73](https://github.com/cy7su/remnawave-bot/commit/10f2f7331537a386646c3d3494c987cf8a028101))
* Make 0040_add_severpay_payments migration idempotent ([941ea60](https://github.com/cy7su/remnawave-bot/commit/941ea6027897c41e71f30c6ab6dea33917158021))
* make close button red using make_button with style=danger ([bba87b6](https://github.com/cy7su/remnawave-bot/commit/bba87b673f3efb87791aa434f9f23649274e1897))
* Make migrations 0045-0098 idempotent ([6a1c0e2](https://github.com/cy7su/remnawave-bot/commit/6a1c0e23008d68e7f8e71269db06a149f24573d7))
* **merge:** restore NotificationType winback/promo members, PromoCodeType.BALANCE_AND_DAYS, pytest import ([aa6634d](https://github.com/cy7su/remnawave-bot/commit/aa6634d50a9ac9440261516233c60571fadbdd7f))
* **merge:** restore NotificationType winback/promo members, PromoCodeType.BALANCE_AND_DAYS, pytest import ([7b12b6d](https://github.com/cy7su/remnawave-bot/commit/7b12b6dcca0b627ef6a76511784a20d03724c0a7))
* **monitoring:** use make_button with styles for notification keyboards ([7c48321](https://github.com/cy7su/remnawave-bot/commit/7c48321b276fe970e9aeaa2b17c6e553a725e8e5))
* pass real from_user to show_pending_inline_gift (callback.message.from_user is the bot) ([f8b8b1a](https://github.com/cy7su/remnawave-bot/commit/f8b8b1accea6409e7e6b086a0e523261c04a5cd9))
* **payment:** add missing description and open_url_direct columns to PaymentMethodConfig model ([0db4458](https://github.com/cy7su/remnawave-bot/commit/0db445808a4b1d181a58f9da66369848d9e3aa85))
* **payment:** add missing description and open_url_direct columns to PaymentMethodConfig model ([73f5e72](https://github.com/cy7su/remnawave-bot/commit/73f5e724857cc5614e006f976b92dcd24b0b90e1))
* **payments:** add missing asyncio import for webhook bg-task helpers ([f687663](https://github.com/cy7su/remnawave-bot/commit/f687663305f169841391479f8e7802caae3ece4e))
* **payments:** add missing asyncio import for webhook bg-task helpers ([748a200](https://github.com/cy7su/remnawave-bot/commit/748a2008fa473cd21ae408353b5824bee25b1ee8))
* per-month показаний через calculate_price_per_month (3.67) ([067b8b7](https://github.com/cy7su/remnawave-bot/commit/067b8b7e69cbda0057aa878463c367fe34feb667))
* premium emoji in topup buttons, bs_ gift deep link handling, remove -bc flag ([88f32e6](https://github.com/cy7su/remnawave-bot/commit/88f32e69bf3702e68b253f23645800f57d4f07d1))
* reactivate RemnaWave subscriptions on user restore ([65d33d5](https://github.com/cy7su/remnawave-bot/commit/65d33d593e99dfe83df0867807b7288d14ab967c))
* reject NaN-like uuid values from panel (400 /api/users/NaN) ([441cbe3](https://github.com/cy7su/remnawave-bot/commit/441cbe346930a6438f00a2a37ebcfee952aaff5f))
* **remnawave-v3:** update panel user by numeric id (no uuid), fallback to telegram_id in update_remnawave_user ([e941f63](https://github.com/cy7su/remnawave-bot/commit/e941f6329ce1b5924df00d05d8c6bc35490933f0))
* **remnawave:** PATCH /api/users with id (uuid) instead of uuid ([bd2c53b](https://github.com/cy7su/remnawave-bot/commit/bd2c53ba18795918e4d169162680583cfa98d1b0))
* remove 'Баланс пополнен автоматически!' from payment success messages ([837e927](https://github.com/cy7su/remnawave-bot/commit/837e9273e8b40ddfb86066598e9771e7357b15c2))
* remove begin_nested() from _run_safe to prevent InvalidRequestError; simplify expiring sub notification text; make extend button green ([0bcae5b](https://github.com/cy7su/remnawave-bot/commit/0bcae5ba1113c90bbc61d8572f9716bf63fbe670))
* remove end_date/autopay/action_text placeholders from SUBSCRIPTION_EXPIRING_PAID translations ([813ee35](https://github.com/cy7su/remnawave-bot/commit/813ee35a648c7d7f9282b6ce764e012f0800816d))
* remove indented module-level _PLATFORM_EMOJI (dead code, broke import) ([249c80d](https://github.com/cy7su/remnawave-bot/commit/249c80da083b92e00f24d8d0d3c7c681a820404d))
* remove invalid dependency-type from dependabot config ([7f1900d](https://github.com/cy7su/remnawave-bot/commit/7f1900d06ce0b3842f543b5424e297384f14c143))
* remove shadowing local import of get_subscription_by_user_id (UnboundLocalError) ([7537bcf](https://github.com/cy7su/remnawave-bot/commit/7537bcf0f55da7ea19e321f78d16216077ec75f7))
* remove unused variable after error message change ([fce8cba](https://github.com/cy7su/remnawave-bot/commit/fce8cba57e5a27c32408f12d8c8d0b2cc0b570ba))
* repair locale JSON files (invalid single quotes from ruff format, curly quotes in zh.json) ([b5dab95](https://github.com/cy7su/remnawave-bot/commit/b5dab9590817cc0fee97f67f64098dc5e8a6ac9d))
* replace undefined _get_device_added_keyboard with _get_subscription_keyboard in _handle_device_added ([6028712](https://github.com/cy7su/remnawave-bot/commit/602871216c8b6dc6c770c6db2a10d2de674e09be))
* resolve CodeQL findings; auto-fallback Platega v1-&gt;v2 for card cascades ([df36708](https://github.com/cy7su/remnawave-bot/commit/df36708d1e78896c22433c10bce560439b3a0240))
* restore Bot and AdminNotificationService imports for ban method ([69c6821](https://github.com/cy7su/remnawave-bot/commit/69c6821c33d889a41ce30bad4629dd694030abd5))
* restore field import for temp_traffic_gb ([abf3641](https://github.com/cy7su/remnawave-bot/commit/abf3641c83ff3bf9ab31b809d61fda1ee9ffc592))
* restore separate release-please config and manifest files ([81d2ae2](https://github.com/cy7su/remnawave-bot/commit/81d2ae26792cbf3e7868995069dd8c03f6f43fa5))
* **rich-menu:** add missing Texts.format_device_limit method ([6825467](https://github.com/cy7su/remnawave-bot/commit/6825467745e9a6f62e8433b86c9f62f558222b6a))
* sanitize panel_user_id against NaN/invalid values (Remnawave 3.0.0 numeric id) ([c873f01](https://github.com/cy7su/remnawave-bot/commit/c873f010eae2f9f5df2b4413f138d627a3b52648))
* **security:** bump vulnerable deps, mark weak-hash usage, suppress justified scanner findings ([8262d5d](https://github.com/cy7su/remnawave-bot/commit/8262d5db182c66d390e69107b70b88fe72d2bb28))
* **security:** replace ReDoS-vulnerable regexes in rich admin converter ([1c6ce7a](https://github.com/cy7su/remnawave-bot/commit/1c6ce7aac8a03950e445e526cc10ec33b318d576))
* show device model instead of OS in new device notification ([0b0e482](https://github.com/cy7su/remnawave-bot/commit/0b0e482b1297d8a6b9929ee23a55d60b49c6f15e))
* skip main menu when inline gift is shown after registration ([b1614da](https://github.com/cy7su/remnawave-bot/commit/b1614da5f90a76429d95a1c9dd6e25707cfce90a))
* store intended_sentinel over inline_message_id for proper recipient check ([edd2eca](https://github.com/cy7su/remnawave-bot/commit/edd2eca39cceccc40093aceb5ac4a93907b94760))
* strip UTF-8 BOM from pyproject.toml and CHANGELOG.md ([946fea2](https://github.com/cy7su/remnawave-bot/commit/946fea21fc2df572c55cc2ee9ac85739feab25ad))
* strip UTF-8 BOM from pyproject.toml and CHANGELOG.md ([88dfc87](https://github.com/cy7su/remnawave-bot/commit/88dfc87a0c6a35d9df06c2c90d4a7518ddf1b079))
* **subscription:** in v3 fallback to telegram_id when remnawave_id missing, backfill id ([d6ea34a](https://github.com/cy7su/remnawave-bot/commit/d6ea34ae66362f6148473f0b8314442905b1e2f3))
* **subscription:** validate by panel id in RemnaWave v3 (REMNAWAVE_USE_USER_ID), don't wipe valid short_uuid ([0fb4efd](https://github.com/cy7su/remnawave-bot/commit/0fb4efd3d8d47221ed5aeebe940aae1ccd6c32b6))
* **tariffs:** port upstream single-tariff skip + back_callback threading; fix UnboundLocalError in redraw handlers ([2a280e3](https://github.com/cy7su/remnawave-bot/commit/2a280e36f9faf505b63e2231ee2f77fc4bee4180))
* **tariffs:** port upstream single-tariff skip + back_callback threading; fix UnboundLocalError in redraw handlers ([abccaf1](https://github.com/cy7su/remnawave-bot/commit/abccaf16641718a2cb79d56e8a6487dc9c1e3894))
* temp traffic - only create TrafficPurchase, skip traffic_limit_gb; add debug log for recipient mismatch ([f7a2727](https://github.com/cy7su/remnawave-bot/commit/f7a2727e92294f6b735743c2e2a42b8bd136bf11))
* **tickets,monitoring:** drop stray @ before format_username_link output ([a954407](https://github.com/cy7su/remnawave-bot/commit/a9544075ef26855c94016de097047de564586dfc))
* **tickets,monitoring:** drop stray @ before format_username_link output ([ace87df](https://github.com/cy7su/remnawave-bot/commit/ace87df075d1b946f2a4e0a2a2f77ed974d80dcb))
* **ui:** drop checkmark from activated gift button and language notice, color menu_language blue ([fe1f144](https://github.com/cy7su/remnawave-bot/commit/fe1f144c42544d58ac487caf0540151c2600b885))
* update revoke confirmation button callback for multi-tariff ([6d27a03](https://github.com/cy7su/remnawave-bot/commit/6d27a03398abb694cef9564db505d7ccc326c203))
* update Russian locale with Telegram emoji for confirm button ([faf5ea2](https://github.com/cy7su/remnawave-bot/commit/faf5ea28bb58b582520cb358bbda7900996756ab))
* webhook device notifications show readable model instead of HWID/tag ([1c061ac](https://github.com/cy7su/remnawave-bot/commit/1c061ac93291250d9ddc1d3c0ff913bcc8091982))
* **webhooks:** identifier-less panel events logged as debug, not 'user not found' warnings ([7904be3](https://github.com/cy7su/remnawave-bot/commit/7904be31cc5c8db1cffda493ffd4d268f0f22b5b))
* **webhooks:** identifier-less panel events logged as debug, not 'user not found' warnings ([9072a1b](https://github.com/cy7su/remnawave-bot/commit/9072a1b99faaabedc328dcc0eac3a1e7cfa29402))
* write NULL instead of empty string for remnawave_uuid, rollback tainted sessions ([d8c194d](https://github.com/cy7su/remnawave-bot/commit/d8c194d41033441d21ef2ffe7871d329c9d584b7))
* восстановлен внешний вид страницы устройств из старого бота + исправлен HTML-truncate в кнопках ([0c998cc](https://github.com/cy7su/remnawave-bot/commit/0c998ccd766d63c8ac942246f820a13a34335835))
* замена InlineKeyboardButton на make_button + copy_text для кнопки копирования ссылки ([07b0b0f](https://github.com/cy7su/remnawave-bot/commit/07b0b0fdc048567f78124b2ee936a52686a46a0d))
* исправление ошибки HTML в меню, замена blockquote на code, удаление сообщения с правилами, обновление текста кнопки подключения ([82ecde4](https://github.com/cy7su/remnawave-bot/commit/82ecde4d2ecb5dae6ffc85ec208be221f4a4d46a))
* не показывать неоплаченный черновик триала как подписку (3.67) ([65c8e88](https://github.com/cy7su/remnawave-bot/commit/65c8e88c3d509416566af5775231c18a94af27ee))
* переносы строк в DEVICE_MANAGEMENT_OVERVIEW / CONNECTED_HEADER в locales/ru.json ([18f0980](https://github.com/cy7su/remnawave-bot/commit/18f0980e3366bd21e45cb175ea4f077797346c83))
* премиум эмодзи и URL для кнопки Подключится в MenuLayoutService ([df60585](https://github.com/cy7su/remnawave-bot/commit/df60585856924aee28e796f7d45c78099d9e28c3))
* пустые кнопки пагинации (→/←), стрелки в referral, убраны emoji из SUBSCRIPTION_SETTINGS_OVERVIEW ([4a3cccc](https://github.com/cy7su/remnawave-bot/commit/4a3ccccb46397691613f16a4a458879ca703a526))
* редизайн Настроек подписки - убраны текущие параметры, добавлена сводка (трафик/дата/устройства) и таймер до перевыпуска ([477acdb](https://github.com/cy7su/remnawave-bot/commit/477acdbeab740caa180d7024c6c938e5c1e82107))
* синие кнопки menu_subscription/subscription_manage_devices, исправлена индентация ([64c685d](https://github.com/cy7su/remnawave-bot/commit/64c685d53206e624d812a676c12541e46290b2be))
* убраны действия из устройств, фикс премиум-эмодзи в кнопках, red/danger для reset_all/subscription_revoke, success для connect ([eeb53d7](https://github.com/cy7su/remnawave-bot/commit/eeb53d7b045104bfc4e6de502a535a185e31e7ff))
* убраны мусорные значения deviceModel (To Be Filled By O.E.M. и т.п.) ([32d2feb](https://github.com/cy7su/remnawave-bot/commit/32d2feb24b5abb532a17734d91a6908b4877005e))
* убрать 'Выберите действие:' из главного меню ([e12fb74](https://github.com/cy7su/remnawave-bot/commit/e12fb746641addc33790cae775f3742270ab8b36))
* убрать строку 'Тариф: ...' из главного меню ([5e854ec](https://github.com/cy7su/remnawave-bot/commit/5e854ecd11fb01e96d593d1f285dc1c04fb67888))


### Refactoring

* **grace:** drop GRACE_ACCESS_EXTERNAL_SQUAD_UUID configurable external squad ([d559394](https://github.com/cy7su/remnawave-bot/commit/d559394aab3719e5f7c81ed3f59a5dd93b6ddb5f))
* move main.py/entrypoint.py/bot_logo.png/Makefile out of root into app//assets//scripts, leave relative symlinks in root ([88c6183](https://github.com/cy7su/remnawave-bot/commit/88c6183ded0b23831bada39b4f999133eaaf7225))
* Remove support button from notification preview messages ([4e457ec](https://github.com/cy7su/remnawave-bot/commit/4e457ecfe614ee3a190f0c30c253b56cde9f30b9))
* Simplify main menu text formatting and remove action prompt from localization ([780e161](https://github.com/cy7su/remnawave-bot/commit/780e16112b7b0f88869a8fac582b9bbb18d8ca60))


### Documentation

* add community standards files (README, CODE_OF_CONDUCT, issue/PR templates, logo) ([48c324d](https://github.com/cy7su/remnawave-bot/commit/48c324d109448a291b915f9615ce96cffab72492))
* add community standards files (README, CODE_OF_CONDUCT, issue/PR templates, logo) ([ab6580f](https://github.com/cy7su/remnawave-bot/commit/ab6580fefad6ffcfbf98244a3df589987e1274c7))
* drop usage/FAQ sections and emoji from README headings ([7cad5ed](https://github.com/cy7su/remnawave-bot/commit/7cad5ed85510c07cb849b78ac846c12ea8748da0))
* move md files to docs/, translate to English, remove emojis; delete .env.example and docker-compose.local.yml ([2576923](https://github.com/cy7su/remnawave-bot/commit/257692312c7f978cf5473660ae4606aeb4151a8b))
* **readme:** fix logo image path — use absolute raw URL (symlink resolution broke relative path) ([8b006fe](https://github.com/cy7su/remnawave-bot/commit/8b006fe925d95cd0133823b56357b80f175a6a82))
* **readme:** make logo cross dark and opaque on transparent background ([c86f495](https://github.com/cy7su/remnawave-bot/commit/c86f4959035cefca16e0629aec173843d31e144d))
* **readme:** remove background halo from logo (alpha threshold, keep cross shape) ([91044ad](https://github.com/cy7su/remnawave-bot/commit/91044ad6f1d6f00acea2b5153a999a8bad648e0d))
* **readme:** update logo ([2c1692b](https://github.com/cy7su/remnawave-bot/commit/2c1692bb010f30ebe679d30ffb11e1130b26f760))
* **readme:** update logo ([09f8efa](https://github.com/cy7su/remnawave-bot/commit/09f8efab462e520714d608dc70301c0b10892e5a))
* **readme:** use &lt;picture&gt; element for logo to avoid GitHub img background rendering ([77155fa](https://github.com/cy7su/remnawave-bot/commit/77155fad4e3e3e783f33ba0024b46329f5a59148))
* remove CAUTION/fakes block from README ([e9aeab6](https://github.com/cy7su/remnawave-bot/commit/e9aeab6d9604f01f33ca65f119ee35fab1b840a4))

## [4.1.0](https://github.com/cy7su/remnawave-bot/compare/v4.0.0...v4.1.0) (2026-08-25)
