...
if 'redis.asyncio' not in sys.modules:
    ...
    redis_module.__path__ = []  # маркируем как пакет — иначе 'redis is not a package'
    ...
    redis_exceptions_module.ConnectionError = _FakeRedisError
    ...
    redis_async_module.RedisError = _FakeRedisError
