...
## [4.13.0](https://github.com/0x04A1A430/remnawave-bot/compare/v4.12.1...v4.13.0) (2026-09-19)
...
* add message effects for topup and device connection notifications ([229cb1a](https://github.com/0x04A1A430/remnawave-bot/commit/229cb1aef82b7b12fe25ea51c5acfb32ebf61070))
...
* categorized transaction history, colored balance buttons, topup message tweaks ([ae9f41f](https://github.com/0x04A1A430/remnawave-bot/commit/ae9f41fd28c53c71ad7b473fdada181a2e6ae370))
* clean notification style, back arrows on nav buttons, colored pagination ([fbcd342](https://github.com/0x04A1A430/remnawave-bot/commit/fbcd34290b0983a620ea1097861c8abbf068dfdf))
* colored payment buttons, emoji cleanup in topup flow and notifications ([d9b47bc](https://github.com/0x04A1A430/remnawave-bot/commit/d9b47bc9b4d2c0f159de986d6513fc3cac310e4a))
* delete stale rich main menu when a button opens a screen as new message ([8b67b34](https://github.com/0x04A1A430/remnawave-bot/commit/8b67b3461759c5f28ac7475bdfe1cc1e624a9314))
* **devices:** drop custom device names, show panel data with OS/app versions ([6faa30c](https://github.com/0x04A1A430/remnawave-bot/commit/6faa30c6e51d612d694c1f56f3ad68e56cf6869a))
...
* **gift:** drop bs_ prefix from inline gift deep links ([d6e373f](https://github.com/0x04A1A430/remnawave-bot/commit/d6e373ff76e35edab27f41b4d8b8ffa3007d3fbf))
...
* inline gift extra squad, [@xilarobot](https://github.com/xilarobot) branding, strip admin emoji, old users list markers ([caee42f](https://github.com/0x04A1A430/remnawave-bot/commit/caee42f8949964c0efa180882775901a6ac1de97))
...
* **payments:** unify pay buttons to 'Оплатить {amount}', drop method parentheses, new Platega SBP emoji, replace back arrow with left arrow ([e5177eb](https://github.com/0x04A1A430/remnawave-bot/commit/e5177eb8028a749227957ef51fdfd834cc86fb43))
...
* platega topup screen rework, drop newlines after blockquote tags ([3d57b86](https://github.com/0x04A1A430/remnawave-bot/commit/3d57b8659f125c23e15cb3b77830ea2d0da08535))
...
* promo (campaign) tariffs are non-renewable - offer new tariff choice instead ([9c39bcd](https://github.com/0x04A1A430/remnawave-bot/commit/9c39bcdd744549390d9e73b7bed4bdbeee655d12))
...
* referral list as colored buttons with detail cards and pager ([b3b625b](https://github.com/0x04A1A430/remnawave-bot/commit/b3b625b2644430af23991c1973cefa74b17a0542))
* referral menu and analytics rework with blockquotes, drop invite button ([f524006](https://github.com/0x04A1A430/remnawave-bot/commit/f524006ea59128d85be687b73cb76a704b293858))
...
* rename main menu buttons to short labels, drop plain money emojis in history ([13aea95](https://github.com/0x04A1A430/remnawave-bot/commit/13aea951553b71fa0d7e8fdd8621e4d9edbee46d))
...
* show forever label for subscriptions over 25000 days left ([d72da66](https://github.com/0x04A1A430/remnawave-bot/commit/d72da6617000afd814aeab0e88d66deb3a71ea1f))
* slim down referral main screen, drop footer texts ([d66f70b](https://github.com/0x04A1A430/remnawave-bot/commit/d66f70bd33565398c55efa05da62a616aa76dac0))
...
* align dev symlinks and documentation ([64d86e0](https://github.com/0x04A1A430/remnawave-bot/commit/64d86e0157981009e2f1c25ceac134ff1dbb63dd))
...
* always sync squads on startup, ascii checkboxes in admin server picker ([3c6bda9](https://github.com/0x04A1A430/remnawave-bot/commit/3c6bda9e2fc72d448a44a8eb0775281a25b96ae4))
...
* attach gift migrations to current head ([9f3602a](https://github.com/0x04A1A430/remnawave-bot/commit/9f3602ab49bcccea18ab5aefa65a2d54ba83522f))
...
* **backup:** drop separate success notification, put backup info into file caption (old behaviour) ([8a938c5](https://github.com/0x04A1A430/remnawave-bot/commit/8a938c5d3b28880c09e3097f6f9aedd4c989d1d3))
...
* **codeql:** correct query IDs — py/weak-sensitive-data-hashing + py/overly-permissive-file ([f163674](https://github.com/0x04A1A430/remnawave-bot/commit/f1636743d201a0640978df437defba99061eec1a))
* **codeql:** correct query IDs — py/weak-sensitive-data-hashing + py/overly-permissive-file ([e7372b4](https://github.com/0x04A1A430/remnawave-bot/commit/e7372b414bdaf505847c7ca1abd661ca8dc815a7))
...
* **deps:** bump vulnerable packages (pillow, urllib3, requests, idna, pydantic-settings and others) ([9658904](https://github.com/0x04A1A430/remnawave-bot/commit/9658904867fe2bb0491dd05888f612ab0e2dad50))
...
* drop live panel squad pull in admin server picker ([034edf8](https://github.com/0x04A1A430/remnawave-bot/commit/034edf86058f7f7b7b9610c1a7ef782d91e01243))
...
* fill legacy subscription settings placeholders ([fa8ed26](https://github.com/0x04A1A430/remnawave-bot/commit/fa8ed261d0b1a5ebc55de72c24a3c732e41f6b60))
...
* generate structure from committed tree ([d6f1c58](https://github.com/0x04A1A430/remnawave-bot/commit/d6f1c58ee143ebd62148cb88f6ab1229cf86b3b8))
...
* **gift:** persist grant before panel sync, reload on panel-user recreate ([cbab73d](https://github.com/0x04A1A430/remnawave-bot/commit/cbab73daaf1400445346eaa9fe85887d828a83df))
* **gift:** read gift inline message id before panel sync ([156bde3](https://github.com/0x04A1A430/remnawave-bot/commit/156bde34dcd6b19fb249ae3eb5f88d5d14bfc0f6))
...
* hide cabinet referral links when cabinet disabled, polish transaction card ([762cd47](https://github.com/0x04A1A430/remnawave-bot/commit/762cd47e07bbc9995800b0a9d591a0d3305d7527))
* **inline-gift:** adapt to dev grace/subscription API and localize texts ([152d94c](https://github.com/0x04A1A430/remnawave-bot/commit/152d94c46d3b265ae8a1bf262315049ace0be89d))
* keep dev UI baseline references consistent ([fd8ab24](https://github.com/0x04A1A430/remnawave-bot/commit/fd8ab246755d98da0155192dd1c569218212dba3))
* keep legacy subscription keyboard compatible ([588912a](https://github.com/0x04A1A430/remnawave-bot/commit/588912aabe00350de0c0b545bc1515318c4bd8fb))
...
* **locales:** add CRYPTOBOT_PAY_BUTTON referenced by cryptobot handler ([1e3a56a](https://github.com/0x04A1A430/remnawave-bot/commit/1e3a56a47e309ee7ffd9fa2d3c272ec58d4ecdc0))
* **locales:** pass countries_count to subscription settings, align stale locale templates with code ([2ce80c1](https://github.com/0x04A1A430/remnawave-bot/commit/2ce80c154e714ec1b54a9bb8795283b34d28a961))
...
* **logging:** suppress transient Telegram 5xx/network errors in admin notifier ([f8274d5](https://github.com/0x04A1A430/remnawave-bot/commit/f8274d5d60204e9204a6f1cb5c8967221d25e935))
...
* make structure reference generation reproducible ([4bb1f89](https://github.com/0x04A1A430/remnawave-bot/commit/4bb1f8932089e5799e1692e807c8125e50648de2))
...
* **migrations:** backfill NULL days before SET NOT NULL in inline gift 9102 ([1c9cb31](https://github.com/0x04A1A430/remnawave-bot/commit/1c9cb31e645434027818ca7014de2c6077d7bcf2))
...
* platega locales use {amount} placeholder, restore payment flow ([34c2193](https://github.com/0x04A1A430/remnawave-bot/commit/34c219337cb16611630e0a686eceac5421227ed6))
* **platega:** pass method placeholders to pay button/instructions format, sync stale root locales ([b5efbda](https://github.com/0x04A1A430/remnawave-bot/commit/b5efbda61d94a8882703a2c816e74ec7a44fa564))
...
* preserve balance history pages and refresh user UI ([17eb3e8](https://github.com/0x04A1A430/remnawave-bot/commit/17eb3e858a074acbffc0c0c0c4df20a11e66a093))
* preserve pre-update dev UI ([4869d02](https://github.com/0x04A1A430/remnawave-bot/commit/4869d0288fefa5b37a76c7596cb079e8fa60f3e7))
...
* remove admin emojis and restore inline gifts ([76b7204](https://github.com/0x04A1A430/remnawave-bot/commit/76b7204da624288818fed4f87b11774847f389a3))
...
* remove stale deleted handler imports ([ead8af1](https://github.com/0x04A1A430/remnawave-bot/commit/ead8af19fcc909cb4bd8808cb48dd5e078c054c4))
...
* repair missing campaign column ([da1e210](https://github.com/0x04A1A430/remnawave-bot/commit/da1e210df253828acbb6da9efa47348de1223818))
...
* resolve NameErrors and restore Russian for gift/addon/referral/grace locale keys ([7a7b4a9](https://github.com/0x04A1A430/remnawave-bot/commit/7a7b4a9278c25bf08e5faba05516c1e39f2d486d))
* restore b5efbda dev UI ([fc96b62](https://github.com/0x04A1A430/remnawave-bot/commit/fc96b62c21e010c6c848e52554eaa3833ba05303))
...
* restore green CI suite, tariff list blockquote, admin users page memory ([6da929b](https://github.com/0x04A1A430/remnawave-bot/commit/6da929b9253254a4870b86e5faf210c994ef0fd2))
* restore handler compatibility after UI rollback ([8f81688](https://github.com/0x04A1A430/remnawave-bot/commit/8f816882886efc859b9985e0ac4617603995e376))
* restore lint-clean merged files ([e1e71a9](https://github.com/0x04A1A430/remnawave-bot/commit/e1e71a941f420ffbdd31f402c389330076939c8d))
...
* **rules:** fall back to default-language custom rules when user language has none ([41053c7](https://github.com/0x04A1A430/remnawave-bot/commit/41053c759901254cb70412861ca2e5cf7cab0f9e))
...
* satisfy lint checks ([8bc21a0](https://github.com/0x04A1A430/remnawave-bot/commit/8bc21a06da425b64b646eee70e09ef52cc83cba9))
...
* simplify subscription details display ([19e82f0](https://github.com/0x04A1A430/remnawave-bot/commit/19e82f075c1b4ac127e3d21785273d2fe377c1bd))
...
* **start:** route /start bs_&lt;code&gt; deeplinks to inline gift handler ([5812389](https://github.com/0x04A1A430/remnawave-bot/commit/5812389ac5b09a66e27ee92e6af803b12de86b71))
...
* **tariffs:** pass db session + promo group to get_tariffs_for_user, guard call args in tests ([431cfb4](https://github.com/0x04A1A430/remnawave-bot/commit/431cfb49ed1162083ccd887df630285c00d1bf44))
...
* **ui:** restore old-bot visual parity (admin + client screens) ([7c43f5b](https://github.com/0x04A1A430/remnawave-bot/commit/7c43f5bea94fcbd8cb703fcfa5fc1c994a9bb891))
...
* use repository-relative links in dev ([9695157](https://github.com/0x04A1A430/remnawave-bot/commit/9695157d81259315ffe06aa58de6a07df8fe6a11))
...
* render rich main menu from classic menu text ([542fe53](https://github.com/0x04A1A430/remnawave-bot/commit/542fe533ce3339b764270616af023e711fe258eb))
...
* **readme:** update logo ([2c1692b](https://github.com/0x04A1A430/remnawave-bot/commit/2c1692bb010f30ebe679d30ffb11e1130b26f760))
* **readme:** update logo ([09f8efa](https://github.com/0x04A1A430/remnawave-bot/commit/09f8efab462e520714d608dc70301c0b10892e5a))
* **readme:** use &lt;picture&gt; element for logo to avoid GitHub img background rendering ([77155fa](https://github.com/0x04A1A430/remnawave-bot/commit/77155fad4e3e3e783f33ba0024b46329f5a59148))
* refresh project structure reference ([6792bf3](https://github.com/0x04A1A430/remnawave-bot/commit/6792bf332f21c2dd68f1fef16dc08fdefcc4349e))
