...
class Settings(BaseSettings):
    ...
    BAN_MSG_PUNISHMENT: str = (
        ...
        '<blockquote><b>Причина:</b> превышен лимит устройств\n'
        '{node_info}'
        '<b>Устройств подключено:</b> {ip_count}\n'
        '<b>Разрешено по тарифу:</b> {limit}\n'
        '<b>Время блокировки:</b> {ban_minutes} мин</blockquote>\n\n'
        'Отключите лишние устройства — доступ восстановится автоматически.'
    )
    ...
    BAN_MSG_REVOKE: str = (
        ...
        '{node_info}'
        '<b>Устройств подключено:</b> {ip_count}\n'
        '<b>Разрешено по тарифу:</b> {limit}</blockquote>\n\n'
        'Отключите лишние устройства и получите новый ключ подключения в боте.'
    )
    ...
    BAN_MSG_ENABLED: str = (
        ...
        '<blockquote>Следите за количеством устройств и не превышайте лимит по тарифу.</blockquote>'
    )
    ...
    BAN_MSG_WIFI: str = (
        '<b>Аккаунт заблокирован</b>\n\n'
        '<blockquote><b>Причина:</b> использование WiFi-сети\n'
        '{node_info}'
        '<b>Тип подключения:</b> WiFi\n'
        '{network_info}'
        '<b>Время блокировки:</b> {ban_minutes} мин</blockquote>\n\n'
        'Отключитесь от WiFi и используйте мобильный интернет — доступ восстановится автоматически.'
    )
    ...
    BAN_MSG_MOBILE: str = (
        '<b>Аккаунт заблокирован</b>\n\n'
        '<blockquote><b>Причина:</b> использование мобильной сети\n'
        '{node_info}'
        '<b>Тип подключения:</b> мобильная сеть\n'
        '{network_info}'
        '<b>Время блокировки:</b> {ban_minutes} мин</blockquote>\n\n'
        'Подключитесь к WiFi — доступ восстановится автоматически.'
    )
    ...
    BAN_MSG_TORRENT: str = (
        '<b>Аккаунт заблокирован</b>\n\n'
        '<blockquote><b>Причина:</b> обнаружена torrent-активность\n'
        '{node_info}'
        '<b>Детали:</b> {reason}\n'
        '<b>Время блокировки:</b> {ban_minutes} мин</blockquote>\n\n'
    ...
    BAN_MSG_SUSPICIOUS_DESTINATION: str = (
        '<b>Аккаунт заблокирован</b>\n\n'
        '<blockquote><b>Причина:</b> подключение к запрещённому ресурсу\n'
        '{node_info}'
        '<b>Детали:</b> {reason}\n'
        '<b>Время блокировки:</b> {ban_minutes} мин</blockquote>\n\n'
        'Доступ восстановится автоматически после окончания блокировки.'
    ...
    BAN_MSG_TRAFFIC_LIMIT: str = (
        '<b>Аккаунт заблокирован</b>\n\n'
        '<blockquote><b>Причина:</b> превышен допустимый объём трафика\n'
        '{node_info}'
        '<b>Детали:</b> {reason}\n'
        '<b>Время блокировки:</b> {ban_minutes} мин</blockquote>\n\n'
        'Доступ восстановится автоматически после окончания блокировки.'
    ...
    BAN_MSG_MANUAL: str = (
        '<b>Аккаунт заблокирован</b>\n\n'
        '<blockquote><b>Причина:</b> нарушение правил сервиса\n'
        '{node_info}'
        '<b>Детали:</b> {reason}\n'
        '<b>Время блокировки:</b> {ban_minutes} мин</blockquote>\n\n'
        'Доступ восстановится автоматически после окончания блокировки.'
    ...
    def get_platega_method_definitions() -> dict[int, dict[str, str]]:
        return {
            2: {'name': 'СБП QR', 'title': "<tg-emoji emoji-id='5987917196469213507'>📷</tg-emoji> СБП QR"},
