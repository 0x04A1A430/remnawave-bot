...
"""
    ...
    keyboard = [
        ...
        [types.InlineKeyboardButton(text='ℹ Помощь по HTML', callback_data='admin_rules_help')],
...
async def start_edit_rules(callback: types.CallbackQuery, db_user: User, state: FSMContext, db: AsyncSession):
    try:
        ...
        await callback.message.edit_text(
            ...
            reply_markup=types.InlineKeyboardMarkup(
                inline_keyboard=[
                    [types.InlineKeyboardButton(text='ℹ HTML помощь', callback_data='admin_rules_help')],
...
async def show_html_help(callback: types.CallbackQuery, db_user: User, db: AsyncSession):
    ...
    await callback.message.edit_text(
        f'ℹ <b>Справка по HTML форматированию</b>\n\n{help_text}',
        reply_markup=types.InlineKeyboardMarkup(
            inline_keyboard=[
                [types.InlineKeyboardButton(text=' Редактировать правила', callback_data='admin_edit_rules')],
                [types.InlineKeyboardButton(text=' Назад', callback_data='admin_rules')],
