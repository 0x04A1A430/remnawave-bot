    ...
    async def _notify_sbp_recurring(
        ...
        try:
            ...
            messages = {
                ...
                'failed': texts.t('SBP_RECURRING_NOTIFY_FAILED', 'Не удалось списать оплату по СБП-автопродлению.'),
                'past_due': texts.t('SBP_RECURRING_NOTIFY_PAST_DUE', 'СБП-автопродление просрочено.'),
                'cancelled': texts.t('SBP_RECURRING_NOTIFY_CANCELLED', 'СБП-автопродление отменено.'),
